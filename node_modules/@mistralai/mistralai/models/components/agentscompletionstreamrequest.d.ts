...
export declare const AgentsCompletionStreamRequestToolChoice: {
    readonly Auto: "auto";
    readonly None: "none";
    readonly Any: "any";
};
export type AgentsCompletionStreamRequestToolChoice = ClosedEnum<typeof AgentsCompletionStreamRequestToolChoice>;
...
/** @internal */
export declare const AgentsCompletionStreamRequestToolChoice$inboundSchema: z.ZodNativeEnum<typeof AgentsCompletionStreamRequestToolChoice>;
/** @internal */
export declare const AgentsCompletionStreamRequestToolChoice$outboundSchema: z.ZodNativeEnum<typeof AgentsCompletionStreamRequestToolChoice>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
